...
mediaLocation='/home/pi/Desktop/.Project/MediaPlayer/noUSBVideo/01.mp4'
MediaStatus = True
GlobalVideoCounter = 0
GlobalPlayItem = list()
GlobalPlayItemCounter = 0
GlobalUSBFoler = '/media/pi/'
GlobalNoUSBFolder = '/home/pi/Desktop/.Project/MediaPlayer/noUSBVideo/'
...
class MediaPlayer(QtGui.QWidget):
	def __init__(self,app,parent):
		...
		self.bgPic=QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/panel.png')).scaled(QtCore.QSize(self.playerWidth,self.playerHeight))
		self.buttonDepressedPic=QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/depressed.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight))
		self.buttonPressedPic=QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/pressed.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight))
		self.iconPics=[QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/new.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight)),
			QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/play.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight)),
			QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/pause.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight)),
			QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/stop.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight)),
			QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/settings.png')).scaled(QtCore.QSize(self.iconWidth,self.iconHeight)),]
		self.progressBarPic=QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/depressed.png')).scaled(QtCore.QSize(self.playerWidth-20-self.iconWidth*2,self.progressBarHeight))
		self.progressCirclePic=QtGui.QPixmap(QtCore.QString('/home/pi/Desktop/.Project/MediaPlayer/mediaplayer/circle.png')).scaled(QtCore.QSize(self.progressBarHeight*2,self.progressBarHeight*2))
		...
		self.Log = mLog()
		self.logSize = os.path.getsize('/home/pi/Desktop/golfTest.log')
		self.Control = BallControl(self.Log)
		self.CheckFileFolerIfRoot()
		self.GetFileFolder()
		self.timeout = None
		self.start_autoPlay_timer(0.5)
		self.DeviceName = self.fileGetContents("/home/pi/Desktop/DeviceName")
		#self.PingTimer = int(self.fileGetPingTimerContents("/home/pi/Desktop/DevicePingTimer"))
		self.PingTimer = 5
		self.CheckLogSize()
...
##		httpR.SendPingCmd()
	...
	def CheckFileFolerIfRoot(self):
		...
		FolderList = os.listdir("/media/pi/")
		if(len(FolderList)>0):
...
##                MediaStatus = True
	def CheckLogSize(self):
		...
		tmplogSize = os.path.getsize('/home/pi/Desktop/golfTest.log')
		print("CheckLogSize")
		print(self.logSize)
		print(tmplogSize)
		if (tmplogSize>(1024*1024 * 2)) or (tmplogSize==self.logSize):
			copyfile('/home/pi/Desktop/golfTest.log', '/home/pi/Desktop/golfTest.log.1')
			os.remove('/home/pi/Desktop/golfTest.log')
			self.Log = mLog()
...
class TakeBallDialog(QtGui.QDialog):
...
##
##
##		self.connectStatus = QtGui.QLabel(self)
##		self.connectStatus.setText(MsgConnect)
##		self.connectStatus.setPalette(palette)
##		self.connectStatus.move(1450, 50)
##		self.connectStatus.resize(490,70)
##		self.connectStatus.setFont(font)
		...
		#self.txtTransaction_code = QtGui.QLabel(self)
		...
		self.txtTransaction_value = QtGui.QLabel(self)
		self.txtTransaction_value.setText("")
		self.txtTransaction_value.setPalette(palette)
		self.txtTransaction_value.move(660, 500)
		self.txtTransaction_value.resize(490,70)
...
#		self.start_timer(7)
	...
	def checkWifi(self):
		...
		eth0StartPoint = self.findWifiIndex(data, 0, 'eth0')
		wlan0StartPoint = self.findWifiIndex(data, 0, 'wlan0')
		if data[wlan0StartPoint+1].find('inet ') >=0 or data[eth0StartPoint+1].find('inet ')>=0:
			return True
		return False
...
class TakeBallConfirmDialog(QtGui.QDialog):
	def __init__(self, parent, httpR, tmplog):
		QtGui.QDialog.__init__(self, parent, QtCore.Qt.FramelessWindowHint)
		self.setAttribute(QtCore.Qt.WA_DeleteOnClose)
		self.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
		...
		self.txtTake = QtGui.QLabel(self)
		...
		self.txtTake.move(750, 350)
		self.txtTake.resize(490,70)
		...
		self.txtBall = QtGui.QLabel(self)
		...
		self.txtBall.move(750, 520)
		self.txtBall.resize(490,70)
		...
		#self.buttonConfirmOk = QtGui.QPushButton(unicode('確認', 'utf-8'), self)
...
class ErrorDialog(QtGui.QDialog):
	def __init__(self, parent, ErrorTitle, ErrorMsg, tmplog):
		...
		self.txtTransaction_value.move(715, 500)
		self.txtTransaction_value.resize(490,100)
		...
		self.txtTransaction_code.move(715, 30)
		self.txtTransaction_code.resize(490,70)
...
class SuccessDialog(QtGui.QDialog):
	def __init__(self, parent, httpR, tmplog, tmpBallControl):
		...
		self.txtTake.setText(str(httpR.response_take))
		self.txtTake.setPalette(txtTake_palette)
		self.txtTake.move(950, 380)
		self.txtTake.resize(620,240)
		...
		self.txtBall_after = QtGui.QLabel(self)
		...
		self.txtBall_after.move(270, 450)
		self.txtBall_after.resize(490,240)
		...
		self.txtBall_diff = QtGui.QLabel(self)
		self.txtBall_diff.setText(str(diff_value))
		self.txtBall_diff.setPalette(txtBall_palette_diff)
		self.txtBall_diff.move(270, 320)
		self.txtBall_diff.resize(490,240)
